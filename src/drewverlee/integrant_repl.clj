...
(comment
  (integrant.repl/set-prep! (constantly {:formatting-stack.integrant/component {:linters formatting-stack.defaults/default-linters}
                                         :drewverlee.cool/foo                  {:example? true}
                                         }))

  #_(integrant.repl/set-prep! (constantly {}))
